...
const ThreadWelcomeSuggestions: FC = () => {
  return (
    <div className="aui-thread-welcome-suggestions grid w-full gap-2 @md:grid-cols-2">
      {[
        {
          title: "Summarize roof report",
          label: "for RoofReport-65313312",
          action: "Summarize the key findings and measurements from RoofReport-65313312.",
        },
        {
          title: "Extract measurements",
          label: "area, pitch, ridge length",
          action: "Extract roof area, pitch, and ridge length from RoofReport-65313312 as a JSON object.",
        },
        {
          title: "Find damage evidence",
          label: "hail or wind",
          action: "Identify any hail or wind damage noted in RoofReport-65313312 and cite page numbers.",
        },
        {
          title: "Search across reports",
          label: "for 'parapet height'",
          action: "Search all available roof reports for 'parapet height' and list the results with report IDs.",
        },
